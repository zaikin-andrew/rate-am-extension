...
export class AppComponent implements OnInit {
  ...
  public acbaUsd: Observable<string>;
  constructor(private http: HttpClient) {
    ...
    this.acbaUsd = this.http.get(`https://rate.am/calculator/rates.ashx?cr1=USD&hcr=AMD&cr2=RUR&orgId=f3ffb6cf-dbb6-4d43-b49c-f6d71350d7fb&rtype=1&tp=0&l=lang3&r=${(new Date()).getTime()}`).pipe(
      map((rate: any) => (+rate.data.rates[0].buy/+rate.data.rates[1].sell).toFixed(2))
    );
  }
